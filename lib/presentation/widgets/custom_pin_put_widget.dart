...
import 'package:transport_app/styles/pin_put_decoration.dart';
    ...
    return Directionality(
      ...
      child: Pinput(
        defaultPinTheme:defaultPinTheme.copyWith(
          ...
          textStyle: Theme.of(context).textTheme.headline3!.copyWith(color: ColorManager.gray,fontWeight: FontWeight.w700, fontSize: SizeConfig.headline3Size),
        ...
        focusedPinTheme: focusedPinTheme.copyWith(
          height: SizeConfig.height*0.062,
          width: SizeConfig.height*0.07,
          textStyle: Theme.of(context).textTheme.headline3!.copyWith(color:ColorManager.black,fontWeight: FontWeight.w500, fontSize: SizeConfig.pinPutTextSize),
          decoration: BoxDecoration(
            color: ColorManager.white,
            border: Border.all(
